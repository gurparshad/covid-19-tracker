...
import cx from 'classnames'; // this is used to apply multiple classes to a single element.

const Cards = ({ data: { confirmed, recovered, deaths, lastUpdate}}) => {
    // data is destructured from props and then next fields are destructured from data object.
